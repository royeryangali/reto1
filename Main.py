...
while True:
    ...
    if actividad=="1":
        ...
        for image in conn.compute.images():
            ...
            f.write(image.name)
            f.write("\n")
        ###Método alternativo para mostrar datos más específicos de las imágenes en formato JSON
        ...
        ###Método alternativo para mostrar datos más específicos de flavors en formato JSON
